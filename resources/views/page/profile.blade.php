            ...
            <div class="main-left-sidebar">
              <div class="user_profile">
                ...
                <div class="user_pro_status">
                  <ul class="flw-status text-center">
                    <li>
                          ...
                          <div class="w3-container">
                            ...
                            <form class="w3-container w3-display-middle w3-card-4 w3-padding-16" method="POST" id="payment-form" action="{!! URL::to('paypal') !!}">
                              ...
                              <div class="form-group">
                                <!-- <label class="w3-text-blue">Chọn bài viết</label> -->
                                <h3>Chọn bài viết</h3>
                                <select style="width: 100%; word-break: break-all" name="post_id" id="">
                                  @foreach($postRecruiment as $post)
                                  <option style="word-break: break-all" value="{{$post->id}}">{{$post->title}}</option>
                                  @endforeach
                                </select>
                              </div>
                              <div class="form-group">
                ...
                <div class="posts-section">
                  ...
                  <div class="post-bar">
                    <div class="post_topbar">
                      <div class="usy-dt">
                        <img width="50px" height="50px" src="upload/avatar/{{Auth::user()->avatar}}" alt="avatar">
                        <div class="usy-name">
                    ...
                    <div class="post-bar mb-0 mt-2">
                      <div class="d-flex">
                        <div class="thubnail">
                          <a href="http://localhost/passtime/yBox/public/page/hoc-bong/{{$item->id}}"><img style="width: 310px; padding:5px 10px" src="upload/scholarship/{{$item->image}}" alt=""></a>
                        </div>
                        <div class="usy-dt p-1">
                          <img width="50px" height="50px" src="upload/avatar/{{$item->avatar}}" alt="avatar">
                          <div class="usy-name">
                      ...
                      <div class="job-status-bar">
                        <ul class="like-com">
                          ...
                          <li><a class="com"><img src="images/com.png">
